...
//int		CLI_ShellCmd_LoraGetOperationMode(shell_cmd_args *);
...
int		CLI_ShellCmd_LoraOsc(shell_cmd_args *);
...
int		CLI_ShellCmd_LoraReset(shell_cmd_args *);
