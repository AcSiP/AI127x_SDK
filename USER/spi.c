...
void	SpiInit( void )
{
	...
	/* Enable peripheral clocks --------------------------------------------------*/
	/* Enable SPIy clock and GPIO clock for SPIy */
	RCC_APB2PeriphClockCmd( SPI_PIN_MISO_PORT_CLK | SPI_PIN_MOSI_PORT_CLK | SPI_PIN_SCK_PORT_CLK, ENABLE );
	RCC_APB1PeriphClockCmd( SPI_CLK, ENABLE );
...
uint8_t		SpiInOut( uint8_t outData )
{
	...
	*/
	...
	return (uint8_t)SPI_I2S_ReceiveData( SPI_INTERFACE );
	...
	return SPI_ReceiveData8( SPI_INTERFACE );
