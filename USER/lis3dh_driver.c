...
u8_t LIS3DH_ReadReg(u8_t Reg, u8_t* Data) {
  ...
  if(I2C_Master__Read( LIS3DH__I2C_DEFAULT_ADDR, Reg, 1, Data, 20 )) 
	return 1;  //Correct
  else
	return 0;  //Error
}
...
u8_t LIS3DH_WriteReg(u8_t WriteAddr, u8_t Data) {
  ...
  if(I2C_Master__Write( LIS3DH__I2C_DEFAULT_ADDR, WriteAddr, 1, &Data))
	return 1;  //Correct
  else
	return 0;  //Error
}
...
status_t LIS3DH_SetODR(LIS3DH_ODR_t ov){
  ...
  if( !LIS3DH_ReadReg(LIS3DH_CTRL_REG1, &value) )
	{
		Console_Output_String( "LIS3DH set ODR..READ ERR\r\n" );
    return MEMS_ERROR;
  }
  value &= 0x0f;
  ...
  if( !LIS3DH_WriteReg(LIS3DH_CTRL_REG1, value) )
	{
		Console_Output_String( "LIS3DH set ODR..Write ERR\r\n" );
    return MEMS_ERROR;
  }
  return MEMS_SUCCESS;
}
...
* Description    : Interrupt 1 Configuration modeLIS3DH_SetIntConfiguration
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
...
status_t LIS3DH_GetAccAxesRaw(AxesRaw_t* buff) {
  ...
  buff->AXIS_Z = value;
  Console_Output_String( "MEMS SUCCESS\r\n" );
  return MEMS_SUCCESS;
}
...
void LIS3DH_dumpREG(void) {
  u8_t cfg1,src1,reg1,reg2,reg3,reg4,reg5 ;
	uint8_t buf[90]={0};
	extern u16_t checkIRQ;
	//LIS3DH_WriteReg(LIS3DH_CTRL_REG4, 0x21);
  LIS3DH_ReadReg(LIS3DH_CTRL_REG1, &cfg1);
	LIS3DH_ReadReg(LIS3DH_INT1_SRC, &src1);
	LIS3DH_ReadReg(LIS3DH_CTRL_REG1, &reg1);
	LIS3DH_ReadReg(LIS3DH_CTRL_REG2, &reg2);
	LIS3DH_ReadReg(LIS3DH_CTRL_REG3, &reg3);
	LIS3DH_ReadReg(LIS3DH_CTRL_REG4, &reg4);
	LIS3DH_ReadReg(LIS3DH_CTRL_REG5, &reg5);
	sprintf((char*)buf, "int1_cfg=%d,int1_src=%d,ctrl_reg1=%d,ctrl_reg2=%d,ctrl_reg3=%d,ctrl_reg4=%d,ctrl_reg5=%d\r\n", 
												cfg1,src1,reg1,reg2,reg3,reg4,reg5);
	Console_Output_String( "DUMP LIS3DH REG ");
	Console_Output_String( (const char *) buf);
	Console_Output_String( "\r\n");	
  return;  
}
#if 0  //6D position
void LIS3DH_testinit(void) {
	Console_Output_String( "LIS3DH_testinit \r\n");
	LIS3DH_WriteReg(LIS3DH_CTRL_REG1,87);
	LIS3DH_WriteReg(LIS3DH_CTRL_REG2,0);
	LIS3DH_WriteReg(LIS3DH_CTRL_REG3,88);
	LIS3DH_WriteReg(LIS3DH_CTRL_REG4,0);
	LIS3DH_WriteReg(LIS3DH_CTRL_REG5,4);
	//LIS3DH_WriteReg(LIS3DH_CTRL_REG6,0);
	LIS3DH_WriteReg(LIS3DH_INT1_THS,32);
	LIS3DH_WriteReg(LIS3DH_INT1_DURATION,10);
	LIS3DH_WriteReg(LIS3DH_INT1_CFG,255);
	//LIS3DH_WriteReg(LIS3DH_TEMP_CFG_REG,128);
  return;  
}
#else  //Click 
void LIS3DH_testinit(void) {
	Console_Output_String( "LIS3DH_testinit 2\r\n");
	LIS3DH_WriteReg(LIS3DH_CTRL_REG1,87);
	LIS3DH_WriteReg(LIS3DH_CTRL_REG2,0);
	...
	LIS3DH_SetClickTHS(1);
	LIS3DH_SetClickLIMIT(1);
	LIS3DH_SetClickLATENCY(1);
	LIS3DH_SetClickWINDOW(1);
  return;  
}
void LIS3DH_init_CLICK(void) {
	
	Console_Output_String( "LIS3DH CLICK init\r\n");
	LIS3DH_SetODR(LIS3DH_ODR_400Hz);
	LIS3DH_SetMode(LIS3DH_NORMAL);
	LIS3DH_SetAxis(LIS3DH_X_ENABLE | LIS3DH_Y_ENABLE | LIS3DH_Z_ENABLE);
	LIS3DH_SetInt1Pin(LIS3DH_CLICK_ON_PIN_INT1_ENABLE    | LIS3DH_I1_INT1_ON_PIN_INT1_DISABLE |              
                    LIS3DH_I1_INT2_ON_PIN_INT1_DISABLE  | LIS3DH_I1_DRDY1_ON_INT1_DISABLE    |              
                    LIS3DH_I1_DRDY2_ON_INT1_DISABLE     | LIS3DH_WTM_ON_INT1_DISABLE         |           
                    LIS3DH_INT1_OVERRUN_DISABLE  );
	LIS3DH_Int1LatchEnable(MEMS_ENABLE);
	LIS3DH_SetClickCFG(LIS3DH_ZD_DISABLE | LIS3DH_ZS_ENABLE | LIS3DH_YD_DISABLE  | 
                   LIS3DH_YS_ENABLE | LIS3DH_XD_DISABLE  | LIS3DH_XS_ENABLE );
	LIS3DH_SetClickTHS(10);
	LIS3DH_SetClickLIMIT(10);
	LIS3DH_SetClickLATENCY(10);
	LIS3DH_SetClickWINDOW(10);
  return;  
}
#endif
