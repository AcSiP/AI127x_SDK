...
int	main( void )
{
  ...
  if(EnableMaster == false) {
	...
	CmdUART_UartWrite((uint8_t *)"LORA module start RUNNING...", strlen("LORA module start RUNNING..."));
	CmdUART_UartWrite((uint8_t *)"\r\n", strlen("\r\n"));
  
  //TEST//
  int8_t str[10];
  CmdUART_UartWrite((uint8_t *)"tLoRaSettings=", strlen("tLoRaSettings="));
  sprintf((char *)str, "%d", sizeof(tLoRaSettings));
  CmdUART_UartWrite((uint8_t *)str, strlen((const char *)str));
  CmdUART_UartWrite((uint8_t *)"\r\n", strlen("\r\n"));
  CmdUART_UartWrite((uint8_t *)"SaveRecordMyPara_t=", strlen("SaveRecordMyPara_t="));
  sprintf((char *)str, "%d", sizeof(SaveRecordMyPara_t));
  CmdUART_UartWrite((uint8_t *)str, strlen((const char *)str));
  CmdUART_UartWrite((uint8_t *)"\r\n", strlen("\r\n"));
  CmdUART_UartWrite((uint8_t *)"\r\n", strlen("\r\n"));
  
  CmdUART_UartWrite((uint8_t *)"tLoraNodePara=", strlen("tLoraNodePara="));
  sprintf((char *)str, "%d", sizeof(tLoraNodePara));
  CmdUART_UartWrite((uint8_t *)str, strlen((const char *)str));
  CmdUART_UartWrite((uint8_t *)"\r\n", strlen("\r\n"));
  CmdUART_UartWrite((uint8_t *)"SaveRecordNodePara_t=", strlen("SaveRecordNodePara_t="));
  sprintf((char *)str, "%d", sizeof(SaveRecordNodePara_t));
  CmdUART_UartWrite((uint8_t *)str, strlen((const char *)str));
  CmdUART_UartWrite((uint8_t *)"\r\n", strlen("\r\n"));
  CmdUART_UartWrite((uint8_t *)"\r\n", strlen("\r\n"));
  
  CmdUART_UartWrite((uint8_t *)"tLoraNodeSensor=", strlen("tLoraNodeSensor="));
  sprintf((char *)str, "%d", sizeof(tLoraNodeSensor));
  CmdUART_UartWrite((uint8_t *)str, strlen((const char *)str));
  CmdUART_UartWrite((uint8_t *)"\r\n", strlen("\r\n"));
  CmdUART_UartWrite((uint8_t *)"SaveRecordNodeTraceData_t=", strlen("SaveRecordNodeTraceData_t="));
