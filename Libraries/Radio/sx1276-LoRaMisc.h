 ...
 */
#ifndef LIBRARIES_RADIO_SX1276_LORAMISC_H_
#define LIBRARIES_RADIO_SX1276_LORAMISC_H_
...
void		SX1276LoRaSetMaxPayloadLength( uint8_t value );
...
uint8_t		SX1276LoRaGetMaxPayloadLength( void );
...
void		SX1276LoRaSetOscillator( uint8_t manner );
int8_t		SX1276LoRaOutputPower( int8_t value );
uint8_t		SX1276LoRaPowerIndex( int8_t value );

#endif		// LIBRARIES_RADIO_SX1276_LORAMISC_H_
