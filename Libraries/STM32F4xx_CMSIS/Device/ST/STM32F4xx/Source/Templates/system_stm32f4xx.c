/**
  ...
  *        APB2 Prescaler                         | 1
  *-----------------------------------------------------------------------------
  *        HSE Frequency(Hz)                      | 26000000   //fix by JC in 2016/03/10
  *-----------------------------------------------------------------------------
  *        PLL_M                                  | 13         //fix by JC in 2016/03/10
  *-----------------------------------------------------------------------------
  *        PLL_N                                  | 168        //fix by JC in 2016/03/10
  *-----------------------------------------------------------------------------
  *        PLL_P                                  | 4          //fix by JC in 2016/03/10
  *-----------------------------------------------------------------------------
  *        PLL_Q                                  | 7          //fix by JC in 2016/03/10
  *-----------------------------------------------------------------------------
  *        PLLI2S_N                               | NA
  *-----------------------------------------------------------------------------
  *        PLLI2S_R                               | NA
...
/************************* PLL Parameters *************************************/
 ...
 #define PLL_M      13   //fix by JC in 2016/03/10
...
#define PLL_Q      7   //fix by JC in 2016/03/10
...
#define PLL_N      168   //fix by JC in 2016/03/10
/* SYSCLK = PLL_VCO / PLL_P */
#define PLL_P      4   //fix by JC in 2016/03/10
#endif /* STM32F401xx */
